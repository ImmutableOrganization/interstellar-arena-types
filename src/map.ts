...
export const textureUrls = ['floor-checker', 'floor-brick', 'floor-dirt', 'floor-metal', 'floor-stone', 'floor-tile', 'floor-wood', 'road', 'fence', 'concreteBlock', 'transparent'] as const;
